<?php
/**
 * Sidebar partial reutilizable.
 *
 * Requiere que auth_check.php se haya cargado antes (proporciona isAdmin() y sesión activa).
 * Usa $_SESSION directamente para datos del usuario en el footer.
 *
 * Para páginas en subdirectorios define $sidebarBasePath antes de incluir:
 *   $sidebarBasePath = '../';
 *   require_once __DIR__ . '/../includes/_sidebar.php';
 *
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <div class="nav-section">
            ...
            <a href="<?= $sidebarBasePath ?>index.php" class="nav-item <?= in_array(basename($_SERVER['PHP_SELF']), ['index.php','dashboard.php']) ? 'active' : '' ?>">
            ...
            <a href="<?= $sidebarBasePath ?>productos.php" class="nav-item <?= in_array(basename($_SERVER['PHP_SELF']), ['productos.php','nuevo_producto.php','editar_producto.php','eliminar_producto.php']) ? 'active' : '' ?>">
            ...
            <a href="<?= $sidebarBasePath ?>categorias.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'categorias.php' ? 'active' : '' ?>">
            ...
            <a href="<?= $sidebarBasePath ?>marcas.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'marcas.php' ? 'active' : '' ?>">
            ...
            <?php if (isAdmin()): ?>
            <a href="<?= $sidebarBasePath ?>modelos_moto.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'modelos_moto.php' ? 'active' : '' ?>">
            ...
            <a href="<?= $sidebarBasePath ?>proveedores.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'proveedores.php' ? 'active' : '' ?>">
            ...
            <a href="<?= $sidebarBasePath ?>kits.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'kits.php' ? 'active' : '' ?>">
                ...
                <span class="nav-label">Kits / Packs</span>
            </a>
            <?php endif; ?>
        </div>
        <div class="nav-section">
            <span class="nav-section-label">Operaciones</span>
            <a href="<?= $sidebarBasePath ?>movimientos.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'movimientos.php' ? 'active' : '' ?>">
            ...
            <?php if (isAdmin()): ?>
            <a href="<?= $sidebarBasePath ?>importar_csv.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'importar_csv.php' ? 'active' : '' ?>">
        ...
        <div class="nav-section">
            ...
            <a href="<?= $sidebarBasePath ?>auditoria.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'auditoria.php' ? 'active' : '' ?>">
            ...
            <?php if (isAdmin()): ?>
            <a href="<?= $sidebarBasePath ?>empleados.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'empleados.php' ? 'active' : '' ?>">
            ...
            <a href="<?= $sidebarBasePath ?>usuarios.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'usuarios.php' ? 'active' : '' ?>">
                <span class="nav-icon"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/><line x1="16" y1="11" x2="22" y2="11"/><line x1="19" y1="8" x2="19" y2="14"/></svg></span>
                <span class="nav-label">Usuarios</span>
            </a>
            <?php endif; ?>
            <?php if ((($_SESSION['user_role'] ?? '') === 'admin')): ?>
            <a href="<?= $sidebarBasePath ?>perfil_empresa.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'perfil_empresa.php' ? 'active' : '' ?>">
        ...
        <div class="nav-section">
            ...
            <a href="<?= $sidebarBasePath ?>perfil.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'perfil.php' ? 'active' : '' ?>">
                <span class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg></span>
                <span class="nav-label">Mi Perfil</span>
            </a>
            <a href="<?= $sidebarBasePath ?>soporte/mis-tickets.php" class="nav-item <?= str_contains($_SERVER['PHP_SELF'] ?? '', '/soporte/') ? 'active' : '' ?>">
